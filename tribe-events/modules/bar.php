			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					<?php foreach ( $filters as $filter ) : ?>
						<div class="<?php echo esc_attr( $filter['name'] ) ?>-filter"><div id="saied_hide">Events From</div><div id="saied_hide2">By Name, Keyword</div>
							<label class="label-<?php echo esc_attr( $filter['name'] ) ?>" for="one"><?php echo $filter['caption'] ?></label>
